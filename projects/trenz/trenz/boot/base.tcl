...
set rc [catch {
  ...
  set_property webtalk.parent_dir /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/AD_trenz.cache/wt [current_project]
  set_property parent.project_path /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/AD_trenz.xpr [current_project]
  set_property ip_repo_paths {
  /home/wdevries/git/adi_imec_hdl/library
  /home/wdevries/git/ghdl/library
} [current_project]
  update_ip_catalog
  set_property ip_output_repo /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/AD_trenz.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/AD_trenz.runs/synth_1/system_top.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/AD_trenz.srcs/sources_1/bd/system/system.bd
  set_param project.isImplRun false
  read_xdc /home/wdevries/git/adi_imec_hdl/projects/trenz/trenz/system_constr.xdc
  set_param project.isImplRun true
  link_design -top system_top -part xczu7ev-fbvb900-1-e
  set_param project.isImplRun false
